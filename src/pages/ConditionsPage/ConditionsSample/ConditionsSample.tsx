            ...
            <div className={styles.list_con}>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <p>*or deposit if greater.</p>
                        <p>Tailor-made tours may be subject to alternative cancellation terms, which will be communicated to applicable Clients at the time of booking.</p>
                        <p>
                ...
                <div>
                    ...
                    <p>If you become ill, all hospital expenses, doctor fees, and repatriation costs are your responsibility and the Company shall not be liable for any refund of the tour cost.</p>
                </div>
            </div>
        </div>
    );

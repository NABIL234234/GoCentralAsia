...
import TravelDestination from "../../../components/SidePanel/TravelDestination/TravelDestination";
        ...
        <div className={styles.Bl_Con}>
          <div className={styles.Con_Block}>
            ...
            <p className={styles.p}>
              At GoCentralAsia.com, we are committed to providing exceptional service and support to all our travelers.
              Whether you have questions, need assistance, or simply want to share your travel experiences, our team is
              here to help.
            </p>
          </div>
          <div className={styles.Con_Block}>
            ...
            <div className={styles.Block_Dot}>
              <span>•</span>
              <p className={styles.p}>
                Email: For general inquiries, feedback, or support, please email us at
            ...
            <div className={styles.Block_Dot}>
              ...
              <p className={styles.p}>
                ...
                <span className={styles.p_span}>+1 (123) 456-7890.</span> Our phone lines are open Monday to Friday, 9
                AM to 6 PM (GMT).
              </p>
            </div>
            ...
            <div className={styles.Block_Dot}>
              <span>•</span>
              <p className={styles.p}>
                Live Chat: For immediate assistance, use our live chat feature available on our website. Our chat
                support is available 24/7 to help you with any queries.
              </p>
            </div>
          </div>

          <button className={styles.Con_button}>
            <img className={styles.button_img} src={ChatsCircle} alt={'icon'}/>
            Live Chat
          </button>
          ...
          <div className={styles.Con_Block}>
            ...
            <p className={styles.p}>
              Stay connected with us and get the latest updates, travel tips, and exclusive offers by following us on
              social media:
            </p>
          ...
          <div className={styles.Con_Block}>
            ...
            <p className={styles.p}>
              Your feedback is invaluable to us. If you have any suggestions or comments on how we can improve our
              services,
              please send them to <span className={styles.p_span}>feedback@gocentralasia.com.</span>
              We appreciate your input and strive to continuously enhance your travel experience.
            </p>

            <div className={styles.Block_p}>
              <p className={styles.p}>Thank you for choosing GoCentralAsia.com!</p>
